            ...
            if (cInputFormTbl) {
                ...
                cInputFormTbl = $('#c-campaign-tbl').DataTable({
                    ...
                    columnDefs: [{
                        targets: 0,
                        data: null,
                        defaultContent: '<button class="btn btn-sm rounded btn-warning text-capitalize"><i class="fas fa-mouse-pointer mr-2"></i><span class="l-campaign-select">Select</span></button>',
                        className: 'btnColumn',
                        orderable: false
                    }],
                    "language": {
        ...
        if (!/^success$/i.test(r.result || "")) {
            ...
            if (batchTbl) {
                ...
                batchTbl = $('#m-batch-tbl').DataTable({
                    ...
                    columns: [{
                        ...
                        render: function (data, type, row) {
                            if (data == "Y") {
                                return '<button class="btn btn-sm rounded btn-warning text-capitalize m-call"><i class="fas fa-mouse-pointer mr-2"></i><span>' + langJson['l-campaign-select'] + '</span></button>';
                            } else {
                                return "";
                            }
                        }
                        ...
                        render: function (data, type, row) {
                            if (data == "Y") {
                                return '<button class="btn btn-sm rounded btn-warning text-capitalize m-email"><i class="fas fa-mouse-pointer mr-2"></i><span>' + langJson['l-campaign-select'] + '</span></button>';
                            } else {
                                return "";
                            }
                        }
                        ...
                        render: function (data, type, row) {
                            if (data == "Y") {
                                return '<button class="btn btn-sm rounded btn-warning text-capitalize m-sms"><i class="fas fa-mouse-pointer mr-2"></i><span>' + langJson['l-campaign-select'] + '</span></button>';
                            } else {
                                return "";
                            }
                        }
                    }, //20/5/2021 added whatsapp col
                    {
                        ...
                        render: function (data, type, row) {
                            if (data == "Y") {
                                return '<button class="btn btn-sm rounded btn-warning text-capitalize m-whatsapp"><i class="fas fa-mouse-pointer mr-2"></i><span>' + langJson['l-campaign-select'] + '</span></button>';
                            } else {
                                return "";
                            }
                        }
                        ...
                        if (!/^success$/i.test(r.result || "")) {
                            ...
                            $.ajax({
                                ...
                                if (!/^success$/i.test(r.result || "")) {
                                    ...
                                    lowerPartStr += '<div class="card my-2"><div class="card-body"><div class="d-table"><div class="form-group form-inline d-table-row mb-1"><span class="form-label pr-3 d-table-cell l-campaign-from">Assign From</span><select id="m-assign-from" class="form-control d-table-cell"><option value=0 unused=' + unassignment + '>Pool</option>' + agentOptionStr + '</select><span id="m-from-description" class="text-secondary d-table-cell pl-2">Unassignment: ' + unassignment + '</span><span class="form-control"></div>';
                                    // Add Optional Call Result
                                    lowerPartStr += '<div id="m-call-result-container" class="form-group form-inline mb-1 d-none"><span class="d-table-cell mr-2 l-campaign-callstatus">Call Status&nbsp;&nbsp;</span><select id="m-call-result" class="form-control d-table-cell"><option value="NewLead" selected>Null</option><option value="Unreach">Unreach</option><option value="Reached">Reached</option><option value="Successful Order">Successful Order</option></select>' +

                                        '<select id="m-successful-reason" class="d-none form-control">' +
                                    ...
                                    // Add To Select
                                    lowerPartStr += '<div class="form-group form-inline d-table-row mb-1"><span class="form-label pr-3 d-table-cell l-campaign-assignto">Assign To</span><select id="m-assign-to" class="form-control d-table-cell"><option value=0 unused=' + unassignment + '>Pool</option>' + agentOptionStr + '</select><span id="m-to-description" class="text-secondary d-table-cell pl-2">Unassignment: ' + unassignment + '</span></div>';
                                    lowerPartStr += '<div class="form-group d-table-row">&nbsp;</div><div class="form-group d-table-row"><span class="pr-2 d-table-cell l-campaign-numrecords">No. of Records&nbsp;&nbsp;</span><input id="m-assign-no" type="number" min="0" class"form-control w-auto d-table-cell" autocomplete="off" maxlength="6"><span id="m-assignable-description" class="text-secondary d-table-cell pl-2">Available No.: ' + unassignment + '</span></div></div>';
                                    lowerPartStr += '<button id="m-confirm-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2 mt-3"><i class="fas fa-clipboard-check mr-2"></i><span class="l-form-confirm">Confirm</span></button></div></div>';
                ...
                $('#m-batch-tbl tbody').on('click', '.m-email', function () {
                    ...
                    // Add Input
                    lowerPartStr += '<div class="mb-2"><label class="label-control mr-2 l-campaign-date">Date</label><input id="m-calendar" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}" class="rounded pl-2" type="text" placeholder="yyyy-mm-dd" autocomplete="off"><label class="label-control mx-2 l-campaign-time">Time</label><select id="m-hour" class="rounded mr-2"><option val="00">00</option><option val="01">01</option><option val="02">02</option><option val="03">03</option><option val="04">04</option><option val="05">05</option><option val="06">06</option><option val="07">07</option><option val="08">08</option><option val="09">09</option><option val="10">10</option><option val="11">11</option><option val="12">12</option><option val="13">13</option><option val="14">14</option><option val="15">15</option><option val="16">16</option><option val="17">17</option><option val="18">18</option><option val="19">19</option><option val="20">20</option><option val="21">21</option><option val="22">22</option><option val="23">23</option></select><select id="m-min" class="rounded"><option class="00">00</option><option class="15">15</option><option class="30">30</option><option class="45">45</option></select></div></div></div></div>';
                    ...
                    // Add Subject
                    lowerPartStr += '<div class="form-inline d-flex mb-2"><label class="control-label mr-2 l-campaign-subject">Subject</label><input class="form-control flex-grow-1" id="m-mail-subject" type="search" maxlength="100" autocomplete="off" value="' + emailSubject + '"></div>'
                    // Add Editor
                    ...
                    lowerPartStr += ('<div class="form-inline my-2"><label for="emailFile-attachment" class="control-label mr-2 l-campaign-attachment">Attachment</label>' +
                    ...
                    lowerPartStr += ('<div class="d-table">' +
                        '<div class="d-table-row"><b class="d-table-cell l-campaign-field">Field</b><b class="d-table-cell l-campaign-variable">Variable</b><b class="d-table-cell"></b><b class="d-table-cell pl-5 l-campaign-field">Field</b><b class="d-table-cell l-campaign-variable">Variable</b><b class="d-table-cell"></b></div>' +
                        '<div class="d-table-row"><span class="d-table-cell pr-2 l-form-full-name">Full Name</span><span class="d-table-cell pr-2">{{FullName}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell pr-2 pl-5 l-campaign-mobile-num">Mobile No</span><span class="d-table-cell pr-2">{{Mobile}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span></div>' +
                        '<div class="d-table-row"><span class="d-table-cell pr-2 l-form-title">Title</span><span class="d-table-cell pr-2">{{Title}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell pr-2 pl-5 l-campaign-home-num">Home No</span><span class="d-table-cell pr-2">{{Home}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span></div>' +
                        '<div class="d-table-row"><span class="d-table-cell pr-2 l-form-email">Email</span><span class="d-table-cell pr-2">{{Email}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell pr-2 pl-5 l-campaign-work-num">Work No</span><span class="d-table-cell pr-2">{{Work}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span></div>' +
                        '</div></div></div>');
                    lowerPartStr += '<div class="card my-2"><div class="card-body"><div class="c-section">';
                    lowerPartStr += ('<div class="d-table">' +
                        '<div class="d-table-row"><b class="d-table-cell l-campaign-field">Field</b><b class="d-table-cell l-campaign-test-value">Test Value</b><b class="d-table-cell"></b><b class="d-table-cell pl-5 l-campaign-field">Field</b><b class="d-table-cell l-campaign-test-value">Test Value</b></div>' +
                        '<div class="d-table-row"><span class="d-table-cell pr-2 l-form-full-name">Full Name</span><span class="d-table-cell pr-2">Chan Tai Man</span><span class="d-table-cell pr-2"></span><span class="d-table-cell pr-2 pl-5 l-campaign-mobile-num ">Mobile No</span><span class="d-table-cell pr-2">61234567</span></div>' +
                        '<div class="d-table-row"><span class="d-table-cell pr-2 l-form-title">Title</span><span class="d-table-cell pr-2">Mr.</span><span class="d-table-cell pr-2"></span><span class="d-table-cell pr-2 pl-5 l-campaign-home-num">Home No</span><span class="d-table-cell pr-2">23456789</span></div>' +
                        '<div class="d-table-row"><span class="d-table-cell pr-2 l-form-email">Email</span><span class="d-table-cell pr-2">abc@abcde.com</span><span class="d-table-cell pr-2"></span><span class="d-table-cell pr-2 pl-5 l-campaign-work-num">Work No</span><span class="d-table-cell pr-2">34567890</span></div>' +
                        '</div></div>');
                    // Add Test Email Address
                    lowerPartStr += '<div class="mt-2"><input id="m-test-email" type="email" class="form-control w-25 d-inline" placeholder="' + langJson['l-campaign-type-your-email'] + '" maxlength=100 /><button id="m-send-test-email-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2"><i class="fas fa-paper-plane mr-2"></i><span class="l-campaign-send-test-email">Send Test Email</span></button></div>';
                    ...
                    lowerPartStr += '<h5 class="form-group text-center"><button id="m-email-confirm-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2 btn-cursor-default" disabled><i class="fas fa-save mr-2"></i><span class="l-form-save">Save</span></button></h5></div></div></div>';
                    // Insert String
                ...
                $('#m-batch-tbl tbody').on('click', '.m-sms', function () {
                    ...
                    // '<div class="d-table-row"><span class="d-table-cell pr-2">Full Name</span><span class="d-table-cell pr-2">{{FullName}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell pr-5"><input type="text" class="rounded pl-2" /></span><span class="d-table-cell pr-2">Mobile No</span><span class="d-table-cell pr-2">{{Mobile}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell"><input type="text" class="rounded pl-2"/></span></div>' + 
                    // '<div class="d-table-row"><span class="d-table-cell pr-2">Title</span><span class="d-table-cell pr-2">{{Title}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell pr-5"><input type="text" class="rounded pl-2" /></span><span class="d-table-cell pr-2">Home No</span><span class="d-table-cell pr-2">{{Home}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell"><input type="text" class="rounded pl-2" /></span></div>' + 
                    // '<div class="d-table-row"><span class="d-table-cell pr-2">Email</span><span class="d-table-cell pr-2">{{Email}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell pr-5"><input type="text" class="rounded pl-2" /></span><span class="d-table-cell pr-2">Work No</span><span class="d-table-cell pr-2">{{Work}}</span><span class="d-table-cell pr-2"><i class="fas fa-copy cursor-pointer pop" title="Copied!" data-content="" data-toggle="popover" data-placement="bottom"></i></span><span class="d-table-cell"><input type="text" class="rounded pl-2" /></span></div>' + 
                    // '</div></div>');
                    ...
                    // Add Test SMS
                    lowerPartStr += '<div class="mt-2"><input id="m-test-phone-no" type="tel" class="form-control w-25 d-inline" placeholder="' + langJson['l-campaign-type-your-phone'] + '" maxlength=100 autocomplete="off" /><button id="m-send-test-sms-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2"><i class="fas fa-paper-plane mr-2"></i><span class="l-campaign-send-test-sms">Send Test SMS</span></button><span id="sent-test-sms-lbl" style="display:none;">&nbsp;Sent!</span></div>';
                    ...
                    lowerPartStr += '<h5 class="form-group text-center"><button id="m-sms-confirm-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2 btn-cursor-default" disabled><i class="fas fa-save mr-2"></i><span class="l-form-save">Save</span></button></h5></div></div>';
                    // Insert String
                    $('#m-lower-part').append(lowerPartStr);
                ...
                $('#m-batch-tbl tbody').on('click', '.m-whatsapp', function () {
                    ...
                    // Add Test Whatsapp
                    lowerPartStr += '<div class="mt-2"><input id="m-test-phone-no" type="tel" class="form-control w-25 d-inline" placeholder="' + langJson['l-campaign-type-your-phone'] + '" maxlength=100 autocomplete="off" /><button id="m-send-test-whatsapp-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2"><i class="fas fa-paper-plane mr-2"></i><span class="l-campaign-send-test-whatsapp">Send Test Whatsapp</span></button><span id="sent-test-whatsapp-lbl" style="display:none;">&nbsp;Sent!</span></div>';
                    ...
                    //save btn
                    lowerPartStr += '<h5 class="form-group text-center"><button id="m-whatsapp-confirm-btn" class="btn rounded btn-sm btn-warning text-capitalize ml-2 btn-cursor-default" disabled><i class="fas fa-save mr-2"></i><span class="l-form-save">Save</span></button></h5></div></div>';
                    ...
                    if (sendDateTime != '') { //display latest send out dt & msg
                        ...
                        if (theTemplate.id != 6) { //with image
                            var waContainerStr = (
                                '<div class="form-check form-check-radio ml-4"><label class="form-check-label" for="tp-5"><input checked class="form-check-input" type="radio" name="tp" id="tp-' + theTemplate.id + '" value="' + theTemplate.id + '" props=' + props.length + '>Selected Template ID: ' + theTemplate.id + '</div><span class="circle"><span class="check"></span></span></label></div>'
                            )
                            ...
                            var waContainerStr = (
                                '<div class="form-check form-check-radio ml-4"><label class="form-check-label" for="tp-5"><input checked class="form-check-input" type="radio" name="tp" id="tp-' + tpid + '" value="' + data.tpid + '" props=' + props.length + '>Selected Template ID: ' + tpid + '</div><span class="circle"><span class="check"></span></span></label></div>');
...
$(document).ready(function () {
    if (isAdmin) {
        $('#v-pills-tab').prepend(
            // '<li><a id="add-survey-tab" class="nav-link text-capitalize" data-toggle="pill" href="#add-survey-content" role="tab" aria-controls="add-survey-content" aria-selected="false"><i class="fas fa-plus mr-2"></i> <span class="align-middle">Survey</span> </a></li>' +
            '<li><a id="batch-tab" class="nav-link text-capitalize" data-toggle="pill" href="#batch-content" role="tab" aria-controls="batch-content" aria-selected="false"><i class="fas fa-plus mr-2"></i> <span class="align-middle l-campaign-batch">Batch</span> </a></li>' +
            '<li id="m-manage-content-tab"><a id="manage-tab" class="nav-link text-capitalize" data-toggle="pill" href="#manage-content" role="tab" aria-controls="manage-content" aria-selected="false" style="width:max-content;"><i class="fas fa-tasks mr-2"></i><span class="align-middle l-campaign-manage">Manage</span></a></li>'
        );
                    ...
                    render: function (data, type, row) {
                        if (data) {
                            ...
                            if (new Date(theTime) < new Date()) {
                                return '<i class="fas fa-bell mr-2 text-danger"></i>' + theTime.replace('T', ' ').replace(/\.\d+/, "");
                            } else {
                                return theTime.replace('T', ' ').replace(/\.\d+/, "");
                            }
                        } else {
