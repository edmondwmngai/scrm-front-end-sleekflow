...
"<td><label class='px-2' for='Gender'>Gender</label></td><td><select disabled class='form-control edit-field' name='Gender' id='Gender'><option selected='selected' value=''></option><option value='M'>Male</option><option value='F'>Female</option></select></td>" +
...
"</tr><tr>" +
"<td><label class='px-2' for='Income_level'>Income Level</label></td><td><select disabled class='form-control edit-field' name='Income_level' id='Income_level'><option selected='selected' value=''></option><option value='5000'>HK$0 - HK$5,000</option><option value='10000'>HK$5,001 - HK$10,000</option><option value='20000'>HK$10,001 - HK$20,000</option><option value='50000'>HK$20,001 - HK$50,000</option><option value='50001'>HK$50,001 或以上</option></select></td>" +
