...
var wsWiseAgent = {
            ...
            ws.onmessage = function(evt) {
                ...
                switch (obj.Command) {
                    ...
                    case '11': //AnsCallInfo
                        ...
                        obj.DeviceType = parseInt(obj.CallType);
    ...
    AcceptCallEx: function(CallType, ConnID) {
        ...
        SendCommandToServer(strcommand);
		*/
		var cmd = {"Command" : "193", "CallType" : CallType.toString(), "ConnID" : ConnID.toString()};
		SendCommandToServer(JSON.stringify(cmd));
    },
...
//=====================================================================================================		
		...
		function SendCommandToServer(StrCommand){
		...
		function retryLogin(){
			...
			wsWiseAgent.Login(userName,pass, machineName);
